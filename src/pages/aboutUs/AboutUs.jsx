...
const AboutUs = () => {
  return (
    <div className="intro" style={{width: ' 60%', display: 'block', marginLeft:'20%'}}>
      <h1 style={{textAlign: 'center', marginTop: '40px'}}>Lights, camera, action! </h1>
      ...
      <div>
        <img src={PZT} alt="" style={{height: '180px', marginBottom: ' 30px', border:'solid 2px', borderRadius: '50%'}} />
      ...
      <h5 className="batch" style={{margin: '20px', textAlign:'center'}}>Simbolo React Batch -  2</h5>
    </div>
  );
};
